...
@pytest.fixture
def sample_subcollections(sample_schema: dict) -> dict[str, list[dict]]:
    return sample_schema.get("subcollections", {})


@pytest.fixture
def sample_indexes(sample_schema: dict) -> list[dict]:
    return sample_schema.get("composite_indexes", [])
